...
<section class="pw-section">
  ...
  <div class="pw-grid">
    <div class="pw-cell">
      ...
      <a class="pw-link" href="/en/guide/assembly">Assembly →</a>
    </div>
    <div class="pw-cell">
    ...
    <div class="pw-cell">
      ...
      <a class="pw-link" href="/en/guide/ops-contracts">Contracts →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" href="/en/guide/requests">Requests →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" href="/en/guide/errors">Errors →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" href="/en/guide/responses">Responses →</a>
    </div>
  </div>
</section>
...
app.Run(":8080")</pre>
      <p>Nothing observability-related is configured — once it serves, stdout already carries one line per request. <a class="pw-link" href="/en/guide/getting-started">Full example →</a></p>
    </div>
  </div>
</section>
...
<section class="pw-section pw-cta">
  ...
  <p class="pw-actions">
    <a class="pw-btn" href="/en/performance">Performance</a>
