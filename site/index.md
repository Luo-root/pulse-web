...
<section class="pw-hero">
  ...
  <p class="pw-actions">
    <a class="pw-btn pw-btn-primary" :href="withBase('/guide/getting-started')">快速开始</a>
    <a class="pw-btn" :href="withBase('/guide/observability')">观测怎么用</a>
...
<section class="pw-section">
  ...
  <div class="pw-grid">
    <div class="pw-cell">
      ...
      <a class="pw-link" :href="withBase('/guide/assembly')">看装配 →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" :href="withBase('/guide/observability')">看观测 →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" :href="withBase('/guide/ops-contracts')">看边界 →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" :href="withBase('/guide/requests')">看请求 →</a>
    </div>
    <div class="pw-cell">
      ...
      <a class="pw-link" :href="withBase('/guide/errors')">看错误 →</a>
    </div>
    <div class="pw-cell">
...
app.Run(":8080")</pre>
      <p>没有配任何观测项——起服务之后，日志就已经每请求一行。<a class="pw-link" :href="withBase('/guide/getting-started')">完整示例 →</a></p>
    </div>
  </div>
</section>
...
<section class="pw-section pw-cta">
  ...
  <p class="pw-actions">
    <a class="pw-btn" :href="withBase('/performance')">性能数据</a>
