          ...
          '/': [
            {
              ...
              items: [
                ...
                { text: '数据库集成', link: '/guide/database' },
                { text: 'OpenAPI 工具链', link: '/guide/openapi' },
          ...
          '/en/': [
            {
              ...
              items: [
                ...
                { text: 'Database integration', link: '/en/guide/database' },
                { text: 'OpenAPI tooling', link: '/en/guide/openapi' },
